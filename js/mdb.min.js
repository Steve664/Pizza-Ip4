            ...
            var x = function () {
              ...
              if (
                ...
                if (
                  ...
                  for (var $ = 0; D > $; $++) {
                    var F = { delay: E.delay, progress: E.progress };
                    $ === D - 1 &&
                      ((F.display = E.display),
                ...
                draw: function (t) {
                  ...
                  if (i.display) {
                    ...
                    if (h.drawBorder) {
                      ...
                      m
                        ? ((V = z = "top" === i.position ? e.bottom : e.top),
                          (V += N),
                          (z += N))
                        : ((F = W = "left" === i.position ? e.right : e.left),
                          (F += N),
                          (W += N)),
                        o.beginPath(),
                        o.moveTo(F, V),
    ...
    t(document).on("change", i, function () {
      ...
      t(document).on("input mousedown touchstart", i, function (o) {
        ...
        if (
          ...
          (e = l
            ? o.originalEvent.touches[0].pageX - t(this).offset().left
            : o.pageX - t(this).offset().left) < 0
            ? (e = 0)
            : e > s && (e = s),
          ...
          init: function () {
            if (!s && !l) {
              ...
              e && (a.ui = new e(a, o)).init(),
                ...
                void 0 === $ && (St("initialLayout"), ($ = L = o.getScrollY()));
              var c = "pswp--open ";
              for (
        ...
        publicMethods: {
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              Fe || e !== u ? At(l) : ((tt = c.style), Ne(l, n || l.img)),
                (t.el.innerHTML = ""),
                t.el.appendChild(c);
            } else t.el.innerHTML = "";
          },
            ...
            },
            {
              ...
              value: function () {
                "string" == typeof this.options.stopper
                  ? (this.stopPoint =
                      t(this.stopper).offset().top - this.options.topSpacing)
                  : "number" == typeof this.options.stopper &&
            ...
            },
            {
              ...
              value: function () {
                this.options.stickyClass &&
                  ...
                  this.$element.css({ position: "static", top: e });
              },
            },
            {
              key: "stop",
...
var objectFitImages = (function () {
  ...
  function h(i) {
    var o = (function (t) {
        for (
          var i, n = getComputedStyle(t).fontFamily, o = {};
          null !== (i = e.exec(n));
    ...
    !(function (t) {
      ...
      /scale-down/.test(o["object-fit"])
        ? d(a.img, function () {
            a.img.naturalWidth > i.width || a.img.naturalHeight > i.height
              ? (i.style.backgroundSize = "contain")
              : (i.style.backgroundSize = "auto");
          })
        : (i.style.backgroundSize = o["object-fit"]
            .replace("none", "auto")
  ...
  function p(e, i) {
    ...
    for (var r = 0; r < e.length; r++)
      (e[r][t] = e[r][t] || { skipTest: i.skipTest }), h(e[r]);
    n &&
      ...
      i.watchMQ &&
        window.addEventListener(
          "resize",
          p.bind(null, e, { skipTest: i.skipTest })
        );
  }
  return (
